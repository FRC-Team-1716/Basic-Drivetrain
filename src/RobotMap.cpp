...
void RobotMap::init() {
    ...
    driveSystemRightControl.reset(new Talon(2));
    ...
    driveSystemBackDrive.reset(new RobotDrive(driveSystemFrontLeft, driveSystemRearLeft, driveSystemFrontRight, driveSystemRearRight));
    
    driveSystemBackDrive->SetSafetyEnabled(true);
        driveSystemBackDrive->SetExpiration(0.1);
        driveSystemBackDrive->SetSensitivity(0.5);
        driveSystemBackDrive->SetMaxOutput(1.0);
